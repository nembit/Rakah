  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text style={{ fontFamily: F.semi, fontSize: 10, color: C.teal }}>
            Set bulk
          </Text>
        </TouchableOpacity>
      </View>
      ...
      >
        ...
        {/* Right: Checkmark (decrement) button */}
        <Animated.View style={decStyle}>
          <TouchableOpacity
            ...
            style={{
              ...
              height: 46,
              borderRadius: 23,
              backgroundColor: count > 0 ? `${C.teal}18` : C.cardAlt,
              borderWidth: 1,
              borderColor: count > 0 ? `${C.teal}40` : C.border,
              alignItems: "center",
              justifyContent: "center",
            }}
          >
            <Check
              size={18}
              color={count > 0 ? C.teal : C.textDim}
              strokeWidth={2.2}
            />
          </TouchableOpacity>
        </Animated.View>
